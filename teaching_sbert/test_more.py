...
for n in range(1,190):
        sentences2.append(data1.loc[n]['Passage_one'] + str(int(data1.loc[n]['Score_one'])))
i=1
while i < data.shape[0]:
# for i in range(1,data.shape[0]):
    
    while data.loc[i]['Score_one']==3 :
        i=i+1;
    for n in range(1,len(sentences2)):
        sentences1.append(data.loc[i]['Passage_one'])
#     print(sentences1)
